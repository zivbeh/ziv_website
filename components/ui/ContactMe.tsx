            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-white">
              <motion.div variants={itemVariants}>
                ...
                <div className="mt-3 space-y-1 text-sm">
                  <div>
                    ...
                    <span className="text-white/90">zivbeh at gmail dot com</span>
                  </div>
                  <div>
                    <span className="text-white/60 mr-1">Phone:</span>
                    <span className="text-white/90">408-338-7640</span>
                  </div>
                  <div>
                    <span className="text-white/60 mr-1">GitHub:</span>
                    <span className="text-white/90">github.com/zivbeh</span>
                  </div>
                  <div>
                    <span className="text-white/60 mr-1">LinkedIn:</span>
                    <span className="text-white/90">linkedin.com/in/ziv-behar</span>
                  </div>
                </div>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <motion.button
                  ...
                  className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 transition-colors text-left"
                  variants={itemVariants}
                >
                  <span className="w-5 h-5 rounded-full bg-cyan-500/20 border border-cyan-400/40 flex items-center justify-center text-xs text-cyan-300">
                    @
                  </span>
                  <span className="text-sm text-white/90">Copy email</span>
                </motion.button>
                ...
                >
                  ...
                  <span className="text-sm text-white/90">Copy phone</span>
                </motion.button>
